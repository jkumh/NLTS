...
from models.Gemini import other_completion_fn
from models.Gemini import tokenize_fn as other_tokenize_fn
from models.gpt2 import gpt2_completion_fn, gpt2_nll_fn
from models.gpt2 import tokenize_fn as gpt2_tokenize_fn
from transformers import GPT2LMHeadModel,GPT2Tokenizer
import torch
device = torch.device("cuda:1" if torch.cuda.is_available() else "cpu")
gpt2_model = GPT2LMHeadModel.from_pretrained(
    'language_models/gpt2',
    attn_implementation="eager" 
).to(device)
gpt2_tokenize=GPT2Tokenizer.from_pretrained( 'language_models/gpt2')
...
completion_fns = {
    ...
    'gpt2': partial(gpt2_completion_fn, model='gpt2'),
    ...
    'deepseek-chat': partial(other_completion_fn, model='deepseek-chat'),
    ...
    "doubao-pro-4k": partial(other_completion_fn, model="doubao-pro-4k"),
    "doubao-pro-128k": partial(other_completion_fn, model="doubao-pro-128k"),
    "doubao-pro-32k": partial(other_completion_fn, model="doubao-pro-32k"),
    "doubao-pro-256k": partial(other_completion_fn, model="doubao-pro-256k"),
    "qwen3-1.7b": partial(other_completion_fn, model="qwen3-1.7b"),
    "qwen3-4b": partial(other_completion_fn, model="qwen3-4b"),
...
nll_fns = {
    ...
    'gpt2':partial(gpt2_nll_fn,model='gpt2'),
...
tokenization_fns = {
    ...
    'gpt2': partial(gpt2_tokenize_fn, model='gpt2'),
    ...
    'deepseek-chat': partial(other_tokenize_fn, model='deepseek-chat'),
    ...
    "doubao-pro-4k": partial(other_tokenize_fn, model="doubao-pro-4k"),
    "doubao-pro-32k": partial(other_tokenize_fn, model="doubao-pro-32k"),
    "doubao-pro-128k": partial(other_tokenize_fn, model="doubao-pro-128k"),
    "doubao-pro-256k": partial(other_tokenize_fn, model="doubao-pro-256k"),
    "qwen3-1.7b": partial(other_tokenize_fn, model="qwen3-1.7b"),
    "qwen3-4b": partial(other_tokenize_fn, model="qwen3-4b"),
