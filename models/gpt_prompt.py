...
def gpt_completion_fn(model, input_str, steps, settings, num_samples, temp,all_time_steps,breath_steps,dataname,description=None,seq_len=None):
    """
    ...
    if model in ['gpt-3.5-turbo','gpt-4']:
        ...
        #chatgpt_sys_message = f"The user will provide a sequence and you will predict the remaining sequence. The sequence is represented by decimal strings separated by commas. Each item separated by commas is a time step. And you need to accurately predict the next {all_time_steps} time steps."
